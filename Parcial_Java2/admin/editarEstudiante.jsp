...
<body>
    ...
    <div class="form-ui">
        <div class="card-container">
            <div class="card">
                <div class="content">
                    <p class="heading">Actualizar Estudiante</p>
                    <div class="container">
                        <c:if test="${param.modifica == null}">
                            <!-- Consulta para obtener los datos del coordinador a editar -->
                            <sql:query var="estudiante" dataSource="${proyectos}">
                                SELECT * FROM usuarios WHERE id_usuario = ? AND id_rol = 5;
                        ...
                        <c:if test="${param.modifica != null}">
                            <sql:update var="result" dataSource="${proyectos}">
                                ...
                                WHERE id_usuario = ${param.id_usuario} AND id_rol = 5;
                            </sql:update>

                            <!-- Verificación del éxito de la actualización -->
                            <c:if test="${result >= 1}">
                                <p class="para">¡Estudiante actualizado con éxito!</p>
                                <a href="verEstudiantes.jsp" class="btn btn-primary">Volver</a>
                            </c:if>
                        </c:if>
                    </div>
                </div>
