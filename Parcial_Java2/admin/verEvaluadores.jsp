...
<div class="card-container">
    <div class="card" id="mostrar9-card">
        <div class="content" id="mostrar9-content">
            <div class="heading">Evaluadores</div>
            <br>    

            <sql:query var="result" dataSource="${proyectos}">
                SELECT id_usuario, nombre, correo FROM usuarios WHERE id_rol = 4;
            </sql:query>
                ...
                <tbody>
                    ...
                    <c:forEach var="fila" items="${result.rows}">
                        <tr>
                            ...
                            <td>
                                <a href="editarEvaluador.jsp?id=${fila.id_usuario}">
                                    <input type="submit" class="btn btn-primary" value="Editar" />
                                </a>
                            </td>
                            <td>
                                <a href="eliminarEvaluador.jsp?id=${fila.id_usuario}">
