...
<div class="card-container">
    <div class="card" id="mostrar9-card">
        <div class="content" id="mostrar9-content">
            <div class="heading">Directores</div>
            <br>    

            <sql:query var="result" dataSource="${proyectos}">
                SELECT id_usuario, nombre, correo FROM usuarios WHERE id_rol = 3;
            </sql:query>
                ...
                <tbody>
                    ...
                    <c:forEach var="fila" items="${result.rows}">
                        <tr>
                            ...
                            <td>
                                <a href="editarDirector.jsp?id=${fila.id_usuario}">
                                    <input type="submit" class="btn btn-primary" value="Editar" />
                                </a>
                            </td>
                            <td>
                                <a href="eliminarDirector.jsp?id=${fila.id_usuario}">
