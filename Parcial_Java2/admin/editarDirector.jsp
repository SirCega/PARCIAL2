                    ...
                    <div class="container">
                        <c:if test="${param.modifica == null}">
                            ...
                            <div class="input-area">
                                <form class="form needs-validation" method="post">
                                    <table class="table">
                                        <c:forEach var="item" items="${director.rows}">
                                            <tr>
                                                <td></td>
                        ...
                        <c:if test="${param.modifica != null}">
                            <sql:update var="result" dataSource="${proyectos}">
                                ...
                                WHERE id_usuario = ${param.id_usuario} AND id_rol = 3;
                            </sql:update>

                            <!-- Verificación del éxito de la actualización -->
                            <c:if test="${result >= 1}">
                                <p class="para">¡Director actualizado con éxito!</p>
                                <a href="verDirectores.jsp" class="btn btn-primary">Volver</a>
                            </c:if>
                        </c:if>
                    </div>
                </div>
